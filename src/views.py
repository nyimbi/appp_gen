...
class AgentTierMultipleView(MultipleView):
    datamodel = SQLAInterface(AgentTier)
    views = [UserExtModelView, AgentModelView, BankModelView, AgentTierModelView, StateModelView, CountryModelView, LgaModelView]

appbuilder.add_view(AgentTierMultipleView, "AgentTiers", icon="fa-folder-open-o", category="Inspect")
class StateMultipleView(MultipleView):
    datamodel = SQLAInterface(State)
    views = [UserExtModelView, LgaModelView, StateModelView]

appbuilder.add_view(StateMultipleView, "States", icon="fa-folder-open-o", category="Inspect")
...
class CouponMultipleView(MultipleView):
    datamodel = SQLAInterface(Coupon)
    views = [TransRoutingThresholdsModelView, BillerModelView, BillerOfferingModelView, PromotionModelView, CurrencyModelView, CouponModelView, WalletModelView, BankModelView, AgentModelView, AgentTierModelView, PosModelView, PaymentCardModelView, CustomerSegmentModelView]

appbuilder.add_view(CouponMultipleView, "Coupons", icon="fa-folder-open-o", category="Inspect")
