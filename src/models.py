...
class UserExt(Model):
    ...
    manager = relationship('UserExt', backref='user_exts_manager', primaryjoin='UserExt.manager_id_fk == UserExt.id',
                           remote_side=[id])
...
class Biller(Model):
    ...
    category = relationship(BillerCategory, backref='billers_category',
...
class Token(Model):
    ...
    token_provider = relationship(TokenProvider, backref='tokens_token_provider',
...
class BillerOffering(Model):
    ...
    biller = relationship(Biller, backref='biller_offerings_biller',
...
class Agent(Model):
    ...
    account_manager = relationship(UserExt, backref='agents_account_manager',
                                   primaryjoin='Agent.account_manager_id_fk == UserExt.id')
    agent_tier = relationship(AgentTier, backref='agents_agent_tier',
                              primaryjoin='Agent.agent_tier_id_fk == AgentTier.id')
    aggregator = relationship('Agent', backref='agents_aggregator', primaryjoin='Agent.aggregator_id_fk == Agent.id',
                              remote_side=[id])
    alt_phone_country = relationship(Country, backref='agents_alt_phone_country',
                                     primaryjoin='Agent.alt_phone_country_id_fk == Country.id')
    approved_by = relationship(UserExt, backref='agents_approved_by',
    ...
    kyc_rejection_by = relationship(UserExt, backref='agents_kyc_rejection_by',
                                    primaryjoin='Agent.kyc_rejection_by_id_fk == UserExt.id')
    phone_country = relationship(Country, backref='agents_phone_country',
                                 primaryjoin='Agent.phone_country_id_fk == Country.id')
    registered_by = relationship(UserExt, backref='agents_registered_by',
                                 primaryjoin='Agent.registered_by_id_fk == UserExt.id')
    rejected_by = relationship(UserExt, backref='agents_rejected_by',
                               primaryjoin='Agent.rejected_by_id_fk == UserExt.id')
    reviewed_by = relationship(UserExt, backref='agents_reviewed_by',
...
class Pos(Model):
    ...
    return_received_by = relationship(UserExt, backref='poss_return_received_by',
...
class Commission(Model):
    ...
    agent_tier_level = relationship(AgentTier, backref='commissions_agent_tier_level',
                                    primaryjoin='Commission.agent_tier_level_id_fk == AgentTier.id')
    biller = relationship(Biller, backref='commissions_biller', primaryjoin='Commission.biller_id_fk == Biller.id')
    biller_offering = relationship(BillerOffering, backref='commissions_biller_offering',
                                   primaryjoin='Commission.biller_offering_id_fk == BillerOffering.id')
    currency = relationship(Currency, backref='commissions_currency',
                            primaryjoin='Commission.currency_id_fk == Currency.id')
    customer_segment = relationship(CustomerSegment, backref='commissions_customer_segment',
                                    primaryjoin='Commission.customer_segment_id_fk == CustomerSegment.id')
    lga = relationship(Lga, backref='commissions_lga', primaryjoin='Commission.lga_id_fk == Lga.id')
    risk_profile = relationship(RiskProfile, backref='commissions_risk_profile',
                                primaryjoin='Commission.risk_profile_id_fk == RiskProfile.id')
    special_promotion = relationship(Promotion, backref='commissions_special_promotion',
                                     primaryjoin='Commission.special_promotion_id_fk == Promotion.id')
    state = relationship(State, backref='commissions_state', primaryjoin='Commission.state_id_fk == State.id')
    transaction_type = relationship(TransType, backref='commissions_transaction_type',
                                    primaryjoin='Commission.transaction_type_id_fk == TransType.id')
...
class Person(Model):
    ...
    next_of_kin = relationship('Person', backref='persons_next_of_kin',
                               primaryjoin='Person.next_of_kin_id_fk == Person.id', remote_side=[id])
...
class AgentPersonLink(Model):
    ...
    agent = relationship(Agent, backref='agent_person_links_agent',
                         primaryjoin='AgentPersonLink.agent_id_fk == Agent.id')
    person = relationship(Person, backref='agent_person_links_person',
...
class Contact(Model):
    ...
    contact_type = relationship(ContactType, backref='contacts_contact_type',
...
class Doc(Model):
    ...
    doc_content_type = relationship(MimeType, backref='docs_doc_content_type',
...
class PersonAdminData(Model):
    ...
    person = relationship(Person, backref='person_admin_datas_person',
...
class Trans(Model):
    ...
    agent_tier_level = relationship(AgentTier, backref='transs_agent_tier_level',
    ...
    biller_offering = relationship(BillerOffering, backref='transs_biller_offering',
    ...
    customer_segment = relationship(CustomerSegment, backref='transs_customer_segment',
    ...
    payment_card = relationship(PaymentCard, backref='transs_payment_card',
    ...
    risk_profile = relationship(RiskProfile, backref='transs_risk_profile',
                                primaryjoin='Trans.risk_profile_id_fk == RiskProfile.id')
    special_promotions = relationship(Promotion, backref='transs_special_promotions',
                                      primaryjoin='Trans.special_promotions_id_fk == Promotion.id')
    trans_route = relationship(TransRoutingThresholds, backref='transs_trans_route',
...
class PersonDocLink(Model):
    ...
    person = relationship(Person, backref='person_doc_links_person',
